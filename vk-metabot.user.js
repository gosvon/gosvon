 ...
 */        function generateBotnadzorUrl(...args) {
            ...
            if (type === "card") {
                return `${src_DI.host}/card/${vkDomain}?rand=${generateRandomString()}`;
            }
            return `${src_DI.host}/${type}/${vkDomain}`;
        }
