...
(() => {
    var __webpack_modules__ = {
        600: (module, __webpack_exports__, __webpack_require__) => {
            "use strict";
            __webpack_require__.d(__webpack_exports__, {
                Z: () => __WEBPACK_DEFAULT_EXPORT__
            });
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(457);
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(721);
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(_node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(532);
            var _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(_node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__);
            ...
            var ___CSS_LOADER_EXPORT___ = _node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()(_node_modules_pnpm_css_loader_6_9_0_webpack_5_89_0_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default());
    ...
    (() => {
        ...
        const createStorageValueMigrator = ({storageName, defaultValue, migrations = []}) => {
            ...
            const getUserValueVersion = value => {
                ...
                const versionInUserStorage = gmUtils.getStorageValue(versionStorageName);
            ...
            const getUserValue = () => {
                const realValue = gmUtils.getStorageValue(storageName);
            ...
            const set = newValue => {
                gmUtils.setStorageValue(storageName, JSON.stringify(newValue));
                gmUtils.setStorageValue(versionStorageName, currentVersion);
            };
            const get = () => {
        ...
        async function configStoreFactory(DI) {
            ...
            console.log("Botnadzor: Конфиг по умолчанию", JSON.parse(JSON.stringify(state)), gmUtils);
            ...
            async function fetchConfig() {
                ...
                gmUtils.setStorageValue("gosvon_config_request", JSON.stringify(lastRequest));
        ...
        function getLastConfigRequest() {
            try {
                return JSON.parse(gmUtils.getStorageValue("gosvon_config_request"));
            } catch {
                return undefined;
            }
        }
        ...
        async function botListsFactory(DI) {
            ...
            function saveBotListVersion() {
                gmUtils.setStorageValue("botHighlighterBotListVersion", DI.config.state.botListVersion);
            }
            async function getSavedBotList() {
                return JSON.parse(gmUtils.getStorageValue("botHighlighterSavedBotList") || "[]");
            }
            function getSavedBotListVersion() {
                return gmUtils.getStorageValue("botHighlighterBotListVersion") || "0";
            }
        ...
        function userSettingsFactory(DI) {
            const saved = gmUtils.getStorageValue(STORE_KEY);
            const stateWatchers = [];
            const state = {
            ...
            const update = updator => {
                ...
                dispatchStateUpdate();
                gmUtils.setStorageValue(STORE_KEY, {
        ...
        function registrationDatesFactory() {
            ...
            const fetchUserId = async nickname => {
                const userIdResponse = await gmUtils.http({
            ...
            const fetchRegistrationDate = async userIdOrNickName => {
                ...
                const userInfoResponse = await gmUtils.http({
        ...
        function replyCollectorFactory(DI) {
            const savedState = gmUtils.getStorageValue(STATE_KEY);
            const state = {
            ...
            const saveState = () => {
                gmUtils.setStorageValue(STATE_KEY, state);
            };
        ...
        function tokenStoreFactory(DI) {
            const saved = gmUtils.getStorageValue(tokenStoreFactory_STORE_KEY);
            const stateWatchers = [];
            const state = {
            ...
            const update = updator => {
                Object.assign(state, updator(state));
                dispatchStateUpdate();
                gmUtils.setStorageValue(tokenStoreFactory_STORE_KEY, {
                    ...state,
            ...
            const autoCheckToken = () => {
                const lastCheckDate = gmUtils.getStorageValue("gosvonLastTokenAutoCheck") || 0;
                ...
                checkToken();
                gmUtils.setStorageValue("gosvonLastTokenAutoCheck", Date.now().valueOf());
            };
            const clearToken = () => {
                DI.userSettings.setIsRepliesCollectingEnabled(false);
                update((s => ({
        ...
        function injectNotifications() {
            ...
            const lastClosedNotificationUnix = gmUtils.getStorageValue("gosvonLastClosedNotificationUnix") || 0;
            ...
            const close = () => {
                ...
                gmUtils.setStorageValue("gosvonLastClosedNotificationUnix", src_DI.config.state.message?.unix);
            };
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/information.svg
                var information = __webpack_require__(565);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/eye-outline.svg
                var eye_outline = __webpack_require__(112);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/list-box-outline.svg
                var list_box_outline = __webpack_require__(57);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/account-box-outline.svg
                var account_box_outline = __webpack_require__(758);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/calendar-month-outline.svg
                var calendar_month_outline = __webpack_require__(420);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/information-slab-box-outline.svg
                var information_slab_box_outline = __webpack_require__(69);
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/@mdi+svg@7.4.47/node_modules/@mdi/svg/svg/account-arrow-left-outline.svg
                var account_arrow_left_outline = __webpack_require__(671);
        ...
        function onReplyFormFound(formEl) {
            ...
            attachBotAccountBtn.addEventListener("click", (async () => {
                ...
                const cardLink = `${src_DI.host}/card/id${bot.id}?rand=${generateRandomString()}`;
        ...
        function onNewDesignPostFound(postEl) {
            ...
            if (bot) {
                ...
                const botMarkChip = createLayoutFromString(`\n      <i class="botnadzor-reply-mark-or-type">\n        (${bot.mark?.name || bot.type.name})\n      </i>\n    `);
                const botnadzorLinks = createLayoutFromString(`\n      <span>\n        ${botMarkChip.outerHTML}\n\n        ${bot.type.shouldShowActions ? `\n          <a target='_blank' href='${src_DI.host}/account/id${bot.id}'>\n            Комментарии\n          </a>\n\n          <a target='_blank' href='${src_DI.host}/card/id${bot.id}?rand=${generateRandomString()}'>\n            Карточка\n          </a>\n        ` : ""}\n      </span>\n    `);
                if (postFromAuthorEl) {
        ...
        function onOldDesignPostFound(postEl) {
            ...
            if (bot) {
                ...
                const botMarkChip = createLayoutFromString(`\n      <i class="botnadzor-reply-mark-or-type">\n        (${bot.mark?.name || bot.type.name})\n      </i>\n    `);
                const botnadzorLinks = createLayoutFromString(`\n      <i>\n        ${botMarkChip.outerHTML}\n\n        <a target='_blank' href='${src_DI.host}/account/id${authorId}'>\n            Комментарии\n        </a>\n        <a target='_blank' href='${src_DI.host}/card/id${authorId}?rand=${generateRandomString()}'>\n            Карточка\n        </a>\n      </i>\n    `);
                if (bot.type.shouldShowActions) {
        ...
        function hightlightFan(fanEl) {
            ...
            if (bot.type.shouldShowActions) {
                fanEl.append(createLayoutFromString(`\n        <center>\n          <i>\n            <a target='_blank' href='${src_DI.host}/account/id${userID}'>\n              Комм.\n            </a>\n            <a target='_blank' href='${src_DI.host}/card/id${userID}?rand=${generateRandomString()}'>\n              Карт.\n            </a>\n          </i>\n        </center>\n      `));
            }
        }
        ...
        function onProfileFound(pageNameEl) {
            ...
            if (bot) {
                ...
                const botnadzorLinks = createLayoutFromString(`\n      <i>\n        <a target='_blank' href='${src_DI.host}/account/id${idOrNickname}'>\n            Комментарии\n        </a>\n        <a target='_blank' href='${src_DI.host}/card/id${idOrNickname}?rand=${generateRandomString()}'>\n            Карточка\n        </a>\n      </i>\n    `);
        ...
        function onFoundMobileReply(replyEl) {
            ...
            const anchorEl = registrationDateButtonEl.querySelector(".botnadzor-reply-mobile-action");
        ...
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
                var injectStylesIntoStyleTag = __webpack_require__(944);
        var injectStylesIntoStyleTag_default = __webpack_require__.n(injectStylesIntoStyleTag);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/styleDomAPI.js
                var styleDomAPI = __webpack_require__(616);
        var styleDomAPI_default = __webpack_require__.n(styleDomAPI);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/insertBySelector.js
                var insertBySelector = __webpack_require__(408);
        var insertBySelector_default = __webpack_require__.n(insertBySelector);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js
                var setAttributesWithoutAttributes = __webpack_require__(575);
        var setAttributesWithoutAttributes_default = __webpack_require__.n(setAttributesWithoutAttributes);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/insertStyleElement.js
                var insertStyleElement = __webpack_require__(361);
        var insertStyleElement_default = __webpack_require__.n(insertStyleElement);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/style-loader@3.3.4_webpack@5.89.0/node_modules/style-loader/dist/runtime/styleTagTransform.js
                var styleTagTransform = __webpack_require__(304);
        var styleTagTransform_default = __webpack_require__.n(styleTagTransform);
        // EXTERNAL MODULE: ../../node_modules/.pnpm/css-loader@6.9.0_webpack@5.89.0/node_modules/css-loader/dist/cjs.js!../../node_modules/.pnpm/sass-loader@13.3.3_sass@1.69.7_webpack@5.89.0/node_modules/sass-loader/dist/cjs.js!./src/style.scss
